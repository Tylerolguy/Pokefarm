...
internal static class ItemCatalog
{
    ...
    public static readonly ItemDefinition Tree = new("Tree", new Color(72, 128, 72), ItemKind.ResourceProductionBuilding, true, new Point(56, 56), true, "TREE", PokemonSkill.Lumber, Wood, 5f, 5, 1, 1);
    public static readonly ItemDefinition Farm = new("Farm", new Color(150, 118, 72), ItemKind.ResourceProductionBuilding, true, new Point(72, 56), true, "FARM", PokemonSkill.Farming, OranBerry, 5f, 5, 3, 3);
