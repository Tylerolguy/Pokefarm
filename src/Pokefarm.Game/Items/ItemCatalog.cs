...
internal static class ItemCatalog
{
    ...
    public static readonly ItemDefinition DungeonPortal = new("Dungeon Portal", new Color(136, 136, 144), ItemKind.Building, true, new Point(64, 64), true, "DUNGEON PORTAL", ExitSize: new Point(32, 32), ConstructionEffortRequired: 16f);
